...
# Описание проекта:<br />
Данный проект направлен на разработку веб-приложения для компании, предоставляющей услуги бронирования машин с автопарка
Здесь будет возможность:
- выбрать машину из представленного каталога
- забрать и оплатить заказ в офисе компании или выбрать услугу "доставки машины" по указанному клиентом адресу
- выбора оплаты по qr-коду: сгенерированный код на оплату можно будет отсканировать в личном кабинете пользователя.
